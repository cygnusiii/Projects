...
/**
 * Wrapper for library <b>opus</b><br>
...
public class OpusLibrary {
	...
	/// <i>native declaration : opus\opus_defines.h</i>
	...
	/// <i>native declaration : opus\opus_multistream.h</i>
	 ...
	 * <i>native declaration : opus\opus_defines.h:677</i>
	 */
	synchronized public static Pointer<Byte > opus_strerror(int error) {
		return Pointer.pointerToAddress(opus_strerror$2(error), Byte.class);
	}
	@Ptr 
	@Name("opus_strerror") 
	synchronized protected native static long opus_strerror$2(int error);
	/**
	 * Gets the libopus version string.<br>
	 * * @returns Version string<br>
	 * Original signature : <code>char* opus_get_version_string()</code><br>
	 * <i>native declaration : opus\opus_defines.h:683</i>
	 */
	synchronized public static Pointer<Byte > opus_get_version_string() {
		return Pointer.pointerToAddress(opus_get_version_string$2(), Byte.class);
	}
	@Ptr 
	@Name("opus_get_version_string") 
	synchronized protected native static long opus_get_version_string$2();
	/**
	 ...
	 * <i>native declaration : opus\opus.h:170</i>
	 */
	synchronized native public static int opus_encoder_get_size(int channels);
	/**
	 ...
	 * <i>native declaration : opus\opus.h:207</i>
	 */
	synchronized public static Pointer<OpusLibrary.OpusEncoder > opus_encoder_create(int Fs, int channels, int application, Pointer<Integer > error) {
		return Pointer.pointerToAddress(opus_encoder_create(Fs, channels, application, Pointer.getPeer(error)), OpusLibrary.OpusEncoder.class);
	}
	@Ptr 
	synchronized protected native static long opus_encoder_create(int Fs, int channels, int application, @Ptr long error);
	/**
	 ...
	 * <i>native declaration : opus\opus.h:227</i>
	 */
	synchronized public static int opus_encoder_init(Pointer<OpusLibrary.OpusEncoder > st, int Fs, int channels, int application) {
		return opus_encoder_init(Pointer.getPeer(st), Fs, channels, application);
	}
	synchronized protected native static int opus_encoder_init(@Ptr long st, int Fs, int channels, int application);
	/**
	 ...
	 * <i>native declaration : opus\opus.h:262</i>
	 */
	synchronized public static int opus_encode(Pointer<OpusLibrary.OpusEncoder > st, Pointer<Short > pcm, int frame_size, Pointer<Byte > data, int max_data_bytes) {
		return opus_encode(Pointer.getPeer(st), Pointer.getPeer(pcm), frame_size, Pointer.getPeer(data), max_data_bytes);
	}
	synchronized protected native static int opus_encode(@Ptr long st, @Ptr long pcm, int frame_size, @Ptr long data, int max_data_bytes);
	/**
	 ...
	 * <i>native declaration : opus\opus.h:303</i>
	 */
	synchronized public static int opus_encode_float(Pointer<OpusLibrary.OpusEncoder > st, Pointer<Float > pcm, int frame_size, Pointer<Byte > data, int max_data_bytes) {
		return opus_encode_float(Pointer.getPeer(st), Pointer.getPeer(pcm), frame_size, Pointer.getPeer(data), max_data_bytes);
	}
	synchronized protected native static int opus_encode_float(@Ptr long st, @Ptr long pcm, int frame_size, @Ptr long data, int max_data_bytes);
	/**
	 ...
	 * <i>native declaration : opus\opus.h:314</i>
	 */
	synchronized public static void opus_encoder_destroy(Pointer<OpusLibrary.OpusEncoder > st) {
		opus_encoder_destroy(Pointer.getPeer(st));
	}
	synchronized protected native static void opus_encoder_destroy(@Ptr long st);
	/**
	 ...
	 * <i>native declaration : opus\opus.h:327</i>
	 */
	synchronized public static int opus_encoder_ctl(Pointer<OpusLibrary.OpusEncoder > st, int request, Object... varargs) {
		return opus_encoder_ctl(Pointer.getPeer(st), request);
	}
	synchronized protected native static int opus_encoder_ctl(@Ptr long st, int request, Object... varargs);
	/**
	 ...
	 * <i>native declaration : opus\opus.h:405</i>
	 */
	synchronized native public static int opus_decoder_get_size(int channels);
	/**
	 ...
	 * <i>native declaration : opus\opus.h:422</i>
	 */
	synchronized public static Pointer<OpusLibrary.OpusDecoder > opus_decoder_create(int Fs, int channels, Pointer<Integer > error) {
		return Pointer.pointerToAddress(opus_decoder_create(Fs, channels, Pointer.getPeer(error)), OpusLibrary.OpusDecoder.class);
	}
	@Ptr 
	synchronized protected native static long opus_decoder_create(int Fs, int channels, @Ptr long error);
	/**
	 ...
	 * <i>native declaration : opus\opus.h:439</i>
	 */
	synchronized public static int opus_decoder_init(Pointer<OpusLibrary.OpusDecoder > st, int Fs, int channels) {
		return opus_decoder_init(Pointer.getPeer(st), Fs, channels);
	}
	synchronized protected native static int opus_decoder_init(@Ptr long st, int Fs, int channels);
	/**
	 ...
	 * <i>native declaration : opus\opus.h:461</i>
	 */
	synchronized public static int opus_decode(Pointer<OpusLibrary.OpusDecoder > st, Pointer<Byte > data, int len, Pointer<Short > pcm, int frame_size, int decode_fec) {
		return opus_decode(Pointer.getPeer(st), Pointer.getPeer(data), len, Pointer.getPeer(pcm), frame_size, decode_fec);
	}
	synchronized protected native static int opus_decode(@Ptr long st, @Ptr long data, int len, @Ptr long pcm, int frame_size, int decode_fec);
	/**
	 ...
	 * <i>native declaration : opus\opus.h:486</i>
	 */
	synchronized public static int opus_decode_float(Pointer<OpusLibrary.OpusDecoder > st, Pointer<Byte > data, int len, Pointer<Float > pcm, int frame_size, int decode_fec) {
		return opus_decode_float(Pointer.getPeer(st), Pointer.getPeer(data), len, Pointer.getPeer(pcm), frame_size, decode_fec);
	}
	synchronized protected native static int opus_decode_float(@Ptr long st, @Ptr long data, int len, @Ptr long pcm, int frame_size, int decode_fec);
	/**
	 ...
	 * <i>native declaration : opus\opus.h:506</i>
	 */
	synchronized public static int opus_decoder_ctl(Pointer<OpusLibrary.OpusDecoder > st, int request, Object... varargs) {
		return opus_decoder_ctl(Pointer.getPeer(st), request);
	}
	synchronized protected native static int opus_decoder_ctl(@Ptr long st, int request, Object... varargs);
	/**
	 ...
	 * <i>native declaration : opus\opus.h:511</i>
	 */
	synchronized public static void opus_decoder_destroy(Pointer<OpusLibrary.OpusDecoder > st) {
		opus_decoder_destroy(Pointer.getPeer(st));
	}
	synchronized protected native static void opus_decoder_destroy(@Ptr long st);
	/**
	 ...
	 * <i>native declaration : opus\opus.h:526</i>
	 */
	synchronized public static int opus_packet_parse(Pointer<Byte > data, int len, Pointer<Byte > out_toc, Pointer<Pointer<Byte > > frames, Pointer<Short > size, Pointer<Integer > payload_offset) {
		return opus_packet_parse(Pointer.getPeer(data), len, Pointer.getPeer(out_toc), Pointer.getPeer(frames), Pointer.getPeer(size), Pointer.getPeer(payload_offset));
	}
	synchronized protected native static int opus_packet_parse(@Ptr long data, int len, @Ptr long out_toc, @Ptr long frames, @Ptr long size, @Ptr long payload_offset);
	/**
	 ...
	 * <i>native declaration : opus\opus.h:544</i>
	 */
	synchronized public static int opus_packet_get_bandwidth(Pointer<Byte > data) {
		return opus_packet_get_bandwidth(Pointer.getPeer(data));
	}
	synchronized protected native static int opus_packet_get_bandwidth(@Ptr long data);
	/**
	 ...
	 * <i>native declaration : opus\opus.h:555</i>
	 */
	synchronized public static int opus_packet_get_samples_per_frame(Pointer<Byte > data, int Fs) {
		return opus_packet_get_samples_per_frame(Pointer.getPeer(data), Fs);
	}
	synchronized protected native static int opus_packet_get_samples_per_frame(@Ptr long data, int Fs);
	/**
	 ...
	 * <i>native declaration : opus\opus.h:562</i>
	 */
	synchronized public static int opus_packet_get_nb_channels(Pointer<Byte > data) {
		return opus_packet_get_nb_channels(Pointer.getPeer(data));
	}
	synchronized protected native static int opus_packet_get_nb_channels(@Ptr long data);
	/**
	 ...
	 * <i>native declaration : opus\opus.h:571</i>
	 */
	synchronized public static int opus_packet_get_nb_frames(Pointer<Byte > packet, int len) {
		return opus_packet_get_nb_frames(Pointer.getPeer(packet), len);
	}
	synchronized protected native static int opus_packet_get_nb_frames(@Ptr long packet, int len);
	/**
	 ...
	 * <i>native declaration : opus\opus.h:583</i>
	 */
	synchronized public static int opus_packet_get_nb_samples(Pointer<Byte > packet, int len, int Fs) {
		return opus_packet_get_nb_samples(Pointer.getPeer(packet), len, Fs);
	}
	synchronized protected native static int opus_packet_get_nb_samples(@Ptr long packet, int len, int Fs);
	/**
	 * Gets the number of samples of an Opus packet.<br>
	 ...
	 * <i>native declaration : opus\opus.h:593</i>
	 */
	synchronized public static int opus_decoder_get_nb_samples(Pointer<OpusLibrary.OpusDecoder > dec, Pointer<Byte > packet, int len) {
		return opus_decoder_get_nb_samples(Pointer.getPeer(dec), Pointer.getPeer(packet), len);
	}
	synchronized protected native static int opus_decoder_get_nb_samples(@Ptr long dec, @Ptr long packet, int len);
	/**
	 ...
	 * <i>native declaration : opus\opus.h:605</i>
	 */
	synchronized public static void opus_pcm_soft_clip(Pointer<Float > pcm, int frame_size, int channels, Pointer<Float > softclip_mem) {
		opus_pcm_soft_clip(Pointer.getPeer(pcm), frame_size, channels, Pointer.getPeer(softclip_mem));
	}
	synchronized protected native static void opus_pcm_soft_clip(@Ptr long pcm, int frame_size, int channels, @Ptr long softclip_mem);
	/**
	 ...
	 * <i>native declaration : opus\opus.h:755</i>
	 */
	synchronized native public static int opus_repacketizer_get_size();
	/**
	 ...
	 * <i>native declaration : opus\opus.h:774</i>
	 */
	synchronized public static Pointer<OpusLibrary.OpusRepacketizer > opus_repacketizer_init(Pointer<OpusLibrary.OpusRepacketizer > rp) {
		return Pointer.pointerToAddress(opus_repacketizer_init(Pointer.getPeer(rp)), OpusLibrary.OpusRepacketizer.class);
	}
	@Ptr 
	synchronized protected native static long opus_repacketizer_init(@Ptr long rp);
	/**
	 ...
	 * <i>native declaration : opus\opus.h:779</i>
	 */
	synchronized public static Pointer<OpusLibrary.OpusRepacketizer > opus_repacketizer_create() {
		return Pointer.pointerToAddress(opus_repacketizer_create$2(), OpusLibrary.OpusRepacketizer.class);
	}
	@Ptr 
	@Name("opus_repacketizer_create") 
	synchronized protected native static long opus_repacketizer_create$2();
	/**
	 ...
	 * <i>native declaration : opus\opus.h:785</i>
	 */
	synchronized public static void opus_repacketizer_destroy(Pointer<OpusLibrary.OpusRepacketizer > rp) {
		opus_repacketizer_destroy(Pointer.getPeer(rp));
	}
	synchronized protected native static void opus_repacketizer_destroy(@Ptr long rp);
	/**
	 ...
	 * <i>native declaration : opus\opus.h:834</i>
	 */
	synchronized public static int opus_repacketizer_cat(Pointer<OpusLibrary.OpusRepacketizer > rp, Pointer<Byte > data, int len) {
		return opus_repacketizer_cat(Pointer.getPeer(rp), Pointer.getPeer(data), len);
	}
	synchronized protected native static int opus_repacketizer_cat(@Ptr long rp, @Ptr long data, int len);
	/**
	 ...
	 * <i>native declaration : opus\opus.h:868</i>
	 */
	synchronized public static int opus_repacketizer_out_range(Pointer<OpusLibrary.OpusRepacketizer > rp, int begin, int end, Pointer<Byte > data, int maxlen) {
		return opus_repacketizer_out_range(Pointer.getPeer(rp), begin, end, Pointer.getPeer(data), maxlen);
	}
	synchronized protected native static int opus_repacketizer_out_range(@Ptr long rp, int begin, int end, @Ptr long data, int maxlen);
	/**
	 ...
	 * <i>native declaration : opus\opus.h:880</i>
	 */
	synchronized public static int opus_repacketizer_get_nb_frames(Pointer<OpusLibrary.OpusRepacketizer > rp) {
		return opus_repacketizer_get_nb_frames(Pointer.getPeer(rp));
	}
	synchronized protected native static int opus_repacketizer_get_nb_frames(@Ptr long rp);
	/**
	 * Construct a new packet from data previously submitted to the repacketizer<br>
	 * state via opus_repacketizer_cat().<br>
	 ...
	 * <i>native declaration : opus\opus.h:911</i>
	 */
	synchronized public static int opus_repacketizer_out(Pointer<OpusLibrary.OpusRepacketizer > rp, Pointer<Byte > data, int maxlen) {
		return opus_repacketizer_out(Pointer.getPeer(rp), Pointer.getPeer(data), maxlen);
	}
	synchronized protected native static int opus_repacketizer_out(@Ptr long rp, @Ptr long data, int maxlen);
	/**
	 ...
	 * <i>native declaration : opus\opus.h:925</i>
	 */
	synchronized public static int opus_packet_pad(Pointer<Byte > data, int len, int new_len) {
		return opus_packet_pad(Pointer.getPeer(data), len, new_len);
	}
	synchronized protected native static int opus_packet_pad(@Ptr long data, int len, int new_len);
	/**
	 ...
	 * <i>native declaration : opus\opus.h:938</i>
	 */
	synchronized public static int opus_packet_unpad(Pointer<Byte > data, int len) {
		return opus_packet_unpad(Pointer.getPeer(data), len);
	}
	synchronized protected native static int opus_packet_unpad(@Ptr long data, int len);
	/**
	 ...
	 * <i>native declaration : opus\opus.h:954</i>
	 */
	synchronized public static int opus_multistream_packet_pad(Pointer<Byte > data, int len, int new_len, int nb_streams) {
		return opus_multistream_packet_pad(Pointer.getPeer(data), len, new_len, nb_streams);
	}
	synchronized protected native static int opus_multistream_packet_pad(@Ptr long data, int len, int new_len, int nb_streams);
	/**
	 ...
	 * <i>native declaration : opus\opus.h:969</i>
	 */
	synchronized public static int opus_multistream_packet_unpad(Pointer<Byte > data, int len, int nb_streams) {
		return opus_multistream_packet_unpad(Pointer.getPeer(data), len, nb_streams);
	}
	synchronized protected native static int opus_multistream_packet_unpad(@Ptr long data, int len, int nb_streams);
	/**
	 ...
	 * <i>native declaration : opus\opus_custom.h:83</i>
	 */
	synchronized public static Pointer<OpusLibrary.OpusCustomMode > opus_custom_mode_create(int Fs, int frame_size, Pointer<Integer > error) {
		return Pointer.pointerToAddress(opus_custom_mode_create(Fs, frame_size, Pointer.getPeer(error)), OpusLibrary.OpusCustomMode.class);
	}
	@Ptr 
	synchronized protected native static long opus_custom_mode_create(int Fs, int frame_size, @Ptr long error);
	/**
	 ...
	 * <i>native declaration : opus\opus_custom.h:89</i>
	 */
	synchronized public static void opus_custom_mode_destroy(Pointer<OpusLibrary.OpusCustomMode > mode) {
		opus_custom_mode_destroy(Pointer.getPeer(mode));
	}
	synchronized protected native static void opus_custom_mode_destroy(@Ptr long mode);
	/**
	 ...
	 * <i>native declaration : opus\opus_custom.h:100</i>
	 */
	synchronized public static int opus_custom_encoder_get_size(Pointer<OpusLibrary.OpusCustomMode > mode, int channels) {
		return opus_custom_encoder_get_size(Pointer.getPeer(mode), channels);
	}
	synchronized protected native static int opus_custom_encoder_get_size(@Ptr long mode, int channels);
	/**
	 ...
	 * <i>native declaration : opus\opus_custom.h:136</i>
	 */
	synchronized public static Pointer<OpusLibrary.OpusCustomEncoder > opus_custom_encoder_create(Pointer<OpusLibrary.OpusCustomMode > mode, int channels, Pointer<Integer > error) {
		return Pointer.pointerToAddress(opus_custom_encoder_create(Pointer.getPeer(mode), channels, Pointer.getPeer(error)), OpusLibrary.OpusCustomEncoder.class);
	}
	@Ptr 
	synchronized protected native static long opus_custom_encoder_create(@Ptr long mode, int channels, @Ptr long error);
	/**
	 ...
	 * <i>native declaration : opus\opus_custom.h:146</i>
	 */
	synchronized public static void opus_custom_encoder_destroy(Pointer<OpusLibrary.OpusCustomEncoder > st) {
		opus_custom_encoder_destroy(Pointer.getPeer(st));
	}
	synchronized protected native static void opus_custom_encoder_destroy(@Ptr long st);
	/**
	 ...
	 * <i>native declaration : opus\opus_custom.h:165</i>
	 */
	synchronized public static int opus_custom_encode_float(Pointer<OpusLibrary.OpusCustomEncoder > st, Pointer<Float > pcm, int frame_size, Pointer<Byte > compressed, int maxCompressedBytes) {
		return opus_custom_encode_float(Pointer.getPeer(st), Pointer.getPeer(pcm), frame_size, Pointer.getPeer(compressed), maxCompressedBytes);
	}
	synchronized protected native static int opus_custom_encode_float(@Ptr long st, @Ptr long pcm, int frame_size, @Ptr long compressed, int maxCompressedBytes);
	/**
	 * Encodes a frame of audio.<br>
	 * @param [in] st <tt>OpusCustomEncoder*</tt>: Encoder state<br>
	 ...
	 * <i>native declaration : opus\opus_custom.h:186</i>
	 */
	synchronized public static int opus_custom_encode(Pointer<OpusLibrary.OpusCustomEncoder > st, Pointer<Short > pcm, int frame_size, Pointer<Byte > compressed, int maxCompressedBytes) {
		return opus_custom_encode(Pointer.getPeer(st), Pointer.getPeer(pcm), frame_size, Pointer.getPeer(compressed), maxCompressedBytes);
	}
	synchronized protected native static int opus_custom_encode(@Ptr long st, @Ptr long pcm, int frame_size, @Ptr long compressed, int maxCompressedBytes);
	/**
	 ...
	 * <i>native declaration : opus\opus_custom.h:200</i>
	 */
	synchronized public static int opus_custom_encoder_ctl(Pointer<OpusLibrary.OpusCustomEncoder > st, int request, Object... varargs) {
		return opus_custom_encoder_ctl(Pointer.getPeer(st), request);
	}
	synchronized protected native static int opus_custom_encoder_ctl(@Ptr long st, int request, Object... varargs);
	/**
	 ...
	 * <i>native declaration : opus\opus_custom.h:211</i>
	 */
	synchronized public static int opus_custom_decoder_get_size(Pointer<OpusLibrary.OpusCustomMode > mode, int channels) {
		return opus_custom_decoder_get_size(Pointer.getPeer(mode), channels);
	}
	synchronized protected native static int opus_custom_decoder_get_size(@Ptr long mode, int channels);
	/**
	 * Initializes a previously allocated decoder state<br>
	 ...
	 * <i>native declaration : opus\opus_custom.h:228</i>
	 */
	synchronized public static int opus_custom_decoder_init(Pointer<OpusLibrary.OpusCustomDecoder > st, Pointer<OpusLibrary.OpusCustomMode > mode, int channels) {
		return opus_custom_decoder_init(Pointer.getPeer(st), Pointer.getPeer(mode), channels);
	}
	synchronized protected native static int opus_custom_decoder_init(@Ptr long st, @Ptr long mode, int channels);
	/**
	 ...
	 * <i>native declaration : opus\opus_custom.h:245</i>
	 */
	synchronized public static Pointer<OpusLibrary.OpusCustomDecoder > opus_custom_decoder_create(Pointer<OpusLibrary.OpusCustomMode > mode, int channels, Pointer<Integer > error) {
		return Pointer.pointerToAddress(opus_custom_decoder_create(Pointer.getPeer(mode), channels, Pointer.getPeer(error)), OpusLibrary.OpusCustomDecoder.class);
	}
	@Ptr 
	synchronized protected native static long opus_custom_decoder_create(@Ptr long mode, int channels, @Ptr long error);
	/**
	 ...
	 * <i>native declaration : opus\opus_custom.h:254</i>
	 */
	synchronized public static void opus_custom_decoder_destroy(Pointer<OpusLibrary.OpusCustomDecoder > st) {
		opus_custom_decoder_destroy(Pointer.getPeer(st));
	}
	synchronized protected native static void opus_custom_decoder_destroy(@Ptr long st);
	/**
	 ...
	 * <i>native declaration : opus\opus_custom.h:265</i>
	 */
	synchronized public static int opus_custom_decode_float(Pointer<OpusLibrary.OpusCustomDecoder > st, Pointer<Byte > data, int len, Pointer<Float > pcm, int frame_size) {
		return opus_custom_decode_float(Pointer.getPeer(st), Pointer.getPeer(data), len, Pointer.getPeer(pcm), frame_size);
	}
	synchronized protected native static int opus_custom_decode_float(@Ptr long st, @Ptr long data, int len, @Ptr long pcm, int frame_size);
	/**
	 ...
	 * <i>native declaration : opus\opus_custom.h:282</i>
	 */
	synchronized public static int opus_custom_decode(Pointer<OpusLibrary.OpusCustomDecoder > st, Pointer<Byte > data, int len, Pointer<Short > pcm, int frame_size) {
		return opus_custom_decode(Pointer.getPeer(st), Pointer.getPeer(data), len, Pointer.getPeer(pcm), frame_size);
	}
	synchronized protected native static int opus_custom_decode(@Ptr long st, @Ptr long data, int len, @Ptr long pcm, int frame_size);
	/**
	 ...
	 * <i>native declaration : opus\opus_custom.h:296</i>
	 */
	synchronized public static int opus_custom_decoder_ctl(Pointer<OpusLibrary.OpusCustomDecoder > st, int request, Object... varargs) {
		return opus_custom_decoder_ctl(Pointer.getPeer(st), request);
	}
	synchronized protected native static int opus_custom_decoder_ctl(@Ptr long st, int request, Object... varargs);
	/**
	 ...
	 * <i>native declaration : opus\opus_multistream.h:202</i>
	 */
	synchronized native public static int opus_multistream_encoder_get_size(int streams, int coupled_streams);
	/**
	 * Original signature : <code>opus_int32 opus_multistream_surround_encoder_get_size(int, int)</code><br>
	 * <i>native declaration : opus\opus_multistream.h:207</i>
	 */
	synchronized native public static int opus_multistream_surround_encoder_get_size(int channels, int mapping_family);
	/**
	 ...
	 * <i>native declaration : opus\opus_multistream.h:256</i>
	 */
	synchronized public static Pointer<OpusLibrary.OpusMSEncoder > opus_multistream_encoder_create(int Fs, int channels, int streams, int coupled_streams, Pointer<Byte > mapping, int application, Pointer<Integer > error) {
		return Pointer.pointerToAddress(opus_multistream_encoder_create(Fs, channels, streams, coupled_streams, Pointer.getPeer(mapping), application, Pointer.getPeer(error)), OpusLibrary.OpusMSEncoder.class);
	}
	@Ptr 
	synchronized protected native static long opus_multistream_encoder_create(int Fs, int channels, int streams, int coupled_streams, @Ptr long mapping, int application, @Ptr long error);
	/**
	 ...
	 * <i>native declaration : opus\opus_multistream.h:266</i>
	 */
	synchronized public static Pointer<OpusLibrary.OpusMSEncoder > opus_multistream_surround_encoder_create(int Fs, int channels, int mapping_family, Pointer<Integer > streams, Pointer<Integer > coupled_streams, Pointer<Byte > mapping, int application, Pointer<Integer > error) {
		return Pointer.pointerToAddress(opus_multistream_surround_encoder_create(Fs, channels, mapping_family, Pointer.getPeer(streams), Pointer.getPeer(coupled_streams), Pointer.getPeer(mapping), application, Pointer.getPeer(error)), OpusLibrary.OpusMSEncoder.class);
	}
	@Ptr 
	synchronized protected native static long opus_multistream_surround_encoder_create(int Fs, int channels, int mapping_family, @Ptr long streams, @Ptr long coupled_streams, @Ptr long mapping, int application, @Ptr long error);
	/**
	 ...
	 * <i>native declaration : opus\opus_multistream.h:325</i>
	 */
	synchronized public static int opus_multistream_encoder_init(Pointer<OpusLibrary.OpusMSEncoder > st, int Fs, int channels, int streams, int coupled_streams, Pointer<Byte > mapping, int application) {
		return opus_multistream_encoder_init(Pointer.getPeer(st), Fs, channels, streams, coupled_streams, Pointer.getPeer(mapping), application);
	}
	synchronized protected native static int opus_multistream_encoder_init(@Ptr long st, int Fs, int channels, int streams, int coupled_streams, @Ptr long mapping, int application);
	/**
	 ...
	 * <i>native declaration : opus\opus_multistream.h:335</i>
	 */
	synchronized public static int opus_multistream_surround_encoder_init(Pointer<OpusLibrary.OpusMSEncoder > st, int Fs, int channels, int mapping_family, Pointer<Integer > streams, Pointer<Integer > coupled_streams, Pointer<Byte > mapping, int application) {
		return opus_multistream_surround_encoder_init(Pointer.getPeer(st), Fs, channels, mapping_family, Pointer.getPeer(streams), Pointer.getPeer(coupled_streams), Pointer.getPeer(mapping), application);
	}
	synchronized protected native static int opus_multistream_surround_encoder_init(@Ptr long st, int Fs, int channels, int mapping_family, @Ptr long streams, @Ptr long coupled_streams, @Ptr long mapping, int application);
	/**
	 ...
	 * <i>native declaration : opus\opus_multistream.h:376</i>
	 */
	synchronized public static int opus_multistream_encode(Pointer<OpusLibrary.OpusMSEncoder > st, Pointer<Short > pcm, int frame_size, Pointer<Byte > data, int max_data_bytes) {
		return opus_multistream_encode(Pointer.getPeer(st), Pointer.getPeer(pcm), frame_size, Pointer.getPeer(data), max_data_bytes);
	}
	synchronized protected native static int opus_multistream_encode(@Ptr long st, @Ptr long pcm, int frame_size, @Ptr long data, int max_data_bytes);
	/**
	 ...
	 * <i>native declaration : opus\opus_multistream.h:421</i>
	 */
	synchronized public static int opus_multistream_encode_float(Pointer<OpusLibrary.OpusMSEncoder > st, Pointer<Float > pcm, int frame_size, Pointer<Byte > data, int max_data_bytes) {
		return opus_multistream_encode_float(Pointer.getPeer(st), Pointer.getPeer(pcm), frame_size, Pointer.getPeer(data), max_data_bytes);
	}
	synchronized protected native static int opus_multistream_encode_float(@Ptr long st, @Ptr long pcm, int frame_size, @Ptr long data, int max_data_bytes);
	/**
	 ...
	 * <i>native declaration : opus\opus_multistream.h:433</i>
	 */
	synchronized public static void opus_multistream_encoder_destroy(Pointer<OpusLibrary.OpusMSEncoder > st) {
		opus_multistream_encoder_destroy(Pointer.getPeer(st));
	}
	synchronized protected native static void opus_multistream_encoder_destroy(@Ptr long st);
	/**
	 ...
	 * <i>native declaration : opus\opus_multistream.h:447</i>
	 */
	synchronized public static int opus_multistream_encoder_ctl(Pointer<OpusLibrary.OpusMSEncoder > st, int request, Object... varargs) {
		return opus_multistream_encoder_ctl(Pointer.getPeer(st), request);
	}
	synchronized protected native static int opus_multistream_encoder_ctl(@Ptr long st, int request, Object... varargs);
	/**
	 ...
	 * <i>native declaration : opus\opus_multistream.h:469</i>
	 */
	synchronized native public static int opus_multistream_decoder_get_size(int streams, int coupled_streams);
	/**
	 ...
	 * <i>native declaration : opus\opus_multistream.h:503</i>
	 */
	synchronized public static Pointer<OpusLibrary.OpusMSDecoder > opus_multistream_decoder_create(int Fs, int channels, int streams, int coupled_streams, Pointer<Byte > mapping, Pointer<Integer > error) {
		return Pointer.pointerToAddress(opus_multistream_decoder_create(Fs, channels, streams, coupled_streams, Pointer.getPeer(mapping), Pointer.getPeer(error)), OpusLibrary.OpusMSDecoder.class);
	}
	@Ptr 
	synchronized protected native static long opus_multistream_decoder_create(int Fs, int channels, int streams, int coupled_streams, @Ptr long mapping, @Ptr long error);
	/**
	 ...
	 * <i>native declaration : opus\opus_multistream.h:546</i>
	 */
	synchronized public static int opus_multistream_decoder_init(Pointer<OpusLibrary.OpusMSDecoder > st, int Fs, int channels, int streams, int coupled_streams, Pointer<Byte > mapping) {
		return opus_multistream_decoder_init(Pointer.getPeer(st), Fs, channels, streams, coupled_streams, Pointer.getPeer(mapping));
	}
	synchronized protected native static int opus_multistream_decoder_init(@Ptr long st, int Fs, int channels, int streams, int coupled_streams, @Ptr long mapping);
	/**
	 ...
	 * <i>native declaration : opus\opus_multistream.h:584</i>
	 */
	synchronized public static int opus_multistream_decode(Pointer<OpusLibrary.OpusMSDecoder > st, Pointer<Byte > data, int len, Pointer<Short > pcm, int frame_size, int decode_fec) {
		return opus_multistream_decode(Pointer.getPeer(st), Pointer.getPeer(data), len, Pointer.getPeer(pcm), frame_size, decode_fec);
	}
	synchronized protected native static int opus_multistream_decode(@Ptr long st, @Ptr long data, int len, @Ptr long pcm, int frame_size, int decode_fec);
	/**
	 ...
	 * <i>native declaration : opus\opus_multistream.h:622</i>
	 */
	synchronized public static int opus_multistream_decode_float(Pointer<OpusLibrary.OpusMSDecoder > st, Pointer<Byte > data, int len, Pointer<Float > pcm, int frame_size, int decode_fec) {
		return opus_multistream_decode_float(Pointer.getPeer(st), Pointer.getPeer(data), len, Pointer.getPeer(pcm), frame_size, decode_fec);
	}
	synchronized protected native static int opus_multistream_decode_float(@Ptr long st, @Ptr long data, int len, @Ptr long pcm, int frame_size, int decode_fec);
	/**
	 ...
	 * <i>native declaration : opus\opus_multistream.h:643</i>
	 */
	synchronized public static int opus_multistream_decoder_ctl(Pointer<OpusLibrary.OpusMSDecoder > st, int request, Object... varargs) {
		return opus_multistream_decoder_ctl(Pointer.getPeer(st), request);
	}
	synchronized protected native static int opus_multistream_decoder_ctl(@Ptr long st, int request, Object... varargs);
	/**
	 ...
	 * <i>native declaration : opus\opus_multistream.h:649</i>
	 */
	synchronized public static void opus_multistream_decoder_destroy(Pointer<OpusLibrary.OpusMSDecoder > st) {
		opus_multistream_decoder_destroy(Pointer.getPeer(st));
	}
	synchronized protected native static void opus_multistream_decoder_destroy(@Ptr long st);
	public static class OpusMSEncoder extends TypedPointer {
		public OpusMSEncoder(long address) {
			super(address);
		}
	...
	public static class OpusCustomDecoder extends TypedPointer {
		public OpusCustomDecoder(long address) {
			super(address);
		}
	...
	public static class OpusMSDecoder extends TypedPointer {
		public OpusMSDecoder(long address) {
			super(address);
		}
	...
	public static class OpusCustomEncoder extends TypedPointer {
		public OpusCustomEncoder(long address) {
			super(address);
		}
	...
	public static class OpusCustomMode extends TypedPointer {
		public OpusCustomMode(long address) {
			super(address);
		}
	...
	public static class OpusDecoder extends TypedPointer {
		public OpusDecoder(long address) {
			super(address);
		}
	...
	public static class OpusEncoder extends TypedPointer {
		public OpusEncoder(long address) {
			super(address);
		}
	...
	public static class OpusRepacketizer extends TypedPointer {
		public OpusRepacketizer(long address) {
			super(address);
		}
