package com.iii.facetoface.conference;
...
public class AppChat
{
	...
	public void connect(SingleAction<String> callback,String myName,String myIMEI,String myNumber) throws Exception {
		startSignalling(callback, myName, myIMEI,myNumber);
    ...
    public void startSignalling(SingleAction<String> callback,String myName,String myIMEI,String myNumber) throws Exception
    {
        signalling = new Signalling(websyncServerUrl);
        signalling.start(callback);
        signalling.bindName(myName);
		signalling.bindIMEI(myIMEI);
		signalling.bindNumber(myNumber);
    }
    ...
    public void startConference(final SingleAction<String> callback) throws Exception
    {
        ...
        conference.addOnLinkUp(new SingleAction<LinkUpArgs>(){
        	public void invoke(LinkUpArgs e){
        		...
        		callback.invoke("attach-room"+getPeerName(e)+"--"+getPeerNumber(e)+"--"+getPeerImei(e));
        	}
        });
        conference.addOnLinkDown(new SingleAction<LinkDownArgs>(){
        	public void invoke(LinkDownArgs e){
        		//detach room number to list
        		callback.invoke("detach-room"+getPeerName(e)+"--"+getPeerNumber(e)+"--"+getPeerImei(e));
        	}
        });
